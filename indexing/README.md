...
- `/indexing/transcriptions`. [metagrapho-tropy v0.1.1](https://github.com/RISE-UNIBAS/metagrapho-tropy) was used to add transcriptions generated by the Transkribus Processing API (line model ID 49272 and ATR model ID 39995) to all `Foto` items. These transcriptions were not corrected.
